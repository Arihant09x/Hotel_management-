...
exports.createRoom = async (req, res) => {
  try {
    // Initialize req.files if not present (for JSON requests without files)
    ...
    // room_images is optional for both JSON and formdata
    ...
    } else if (req.body.room_images && Array.isArray(req.body.room_images)) {
      roomImages = req.body.room_images.map((url) => ({ url }));
    }
